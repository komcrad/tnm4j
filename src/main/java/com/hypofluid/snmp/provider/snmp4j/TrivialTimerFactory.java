...
class TrivialTimerFactory implements TimerFactory {
  ...
  class TrivialCommonTimer implements CommonTimer {
    ...
    public void schedule(TimerTask task, long delay) {
      ...
      Snmp4jLogger.logger.debug("scheduled task {} with delay {}", task, delay);
    }
    ...
    public void schedule(TimerTask task, Date firstTime, long period) {
      ...
      Snmp4jLogger.logger.debug("scheduled task {} with firstTime {} and period {}", task,
          firstTime, period);
    }
    ...
    public void schedule(TimerTask task, long delay, long period) {
      ...
      Snmp4jLogger.logger.debug("scheduled task {} with delay {} and period {}", task, delay,
          period);
    }
    ...
    public void cancel() {
      ...
      timer.cancel();
      Snmp4jLogger.logger.debug("canceled timer for task {}", wrapper);
    }
