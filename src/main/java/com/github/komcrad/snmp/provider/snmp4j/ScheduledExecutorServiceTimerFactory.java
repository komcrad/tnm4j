...
class ScheduledExecutorServiceTimerFactory implements TimerFactory {
  ...
  class ScheduledCommonTimer implements CommonTimer {
    ...
    public void schedule(TimerTask task, long delay) {
      ...
      Snmp4jLogger.logger.debug("scheduled timer {} with delay {}", this, delay);
    }
    ...
    public void schedule(TimerTask task, long delay, long period) {
      ...
      Snmp4jLogger.logger.debug("scheduled timer {} with delay {} and period {}", this, delay,
          period);
    }
    ...
    public void cancel() {
      ...
      future.cancel(false);
      Snmp4jLogger.logger.debug("canceled timer " + this);
      future = null;
    }
